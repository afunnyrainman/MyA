 ...
 */
public class LiveAdater extends RecyclerView.Adapter<LiveAdater.viewHolder> {
    ...
    private List<Live> userInfoList = null;
    /**
     * 最右边的图片被触摸的时候
     */
    ...
    public void setUserInfoList(List<Live> userInfoList) {
    ...
    public Live getUser(int postion) {
    ...
    class viewHolder extends RecyclerView.ViewHolder implements
        ...
        public void setDate() {
            Live userInfo = getUser(getAdapterPosition());
            ...
            //Glide.with(context).load(userInfo.getUsername().split("-")[1]).error(R.drawable.ic_menu_camera).into(img_UserUrl);
            tv_title.setText(userInfo.getTitle());
            tv_time.setText(userInfo.getCreatedAt());
        }
