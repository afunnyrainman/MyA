...
public class CommentAdater extends RecyclerView.Adapter<CommentAdater.viewHolder> {
    ...
    public CommentAdater(Context context) {
    ...
    private List<Comment> userInfoList = null;
    /**
     * 最右边的图片被触摸的时候
     */
    ...
    public void setUserInfoList(List<Comment> userInfoList) {
    ...
    public viewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new viewHolder(LayoutInflater.from(parent.getContext()).inflate(
                R.layout.commentitem, parent, false));
    }
    ...
    public Comment getUser(int postion) {
    ...
    class viewHolder extends RecyclerView.ViewHolder implements
        ...
        public void setDate() {
            Comment userInfo = getUser(getAdapterPosition());
            ...
            tv_content.setText(userInfo.getContent());
        }
